...
window.Store = (function () {
  ...
  const initial = () => ({
    ...
    /* آخر خبرٍ رآه هذا الطالب (تاريخ نشره). شارة «جديد» تُحسب منه محلّيًا لا
       من عمودٍ في الخادم: «جديد» صفةٌ بالنسبة إلى القارئ لا إلى الخبر — طالبٌ
       قرأه أمس وآخر غاب شهرًا لا يريان الشيء نفسه. */
    newsSeenAt: null,
