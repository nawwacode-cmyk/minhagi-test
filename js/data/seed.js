/* =============================================================================
   seed.js — محتوى تجريبي: اللغة الفرنسية · الصف التاسع
   في الإصدار الحقيقي يأتي هذا من SQLite المحلية بعد مزامنة Supabase.
   بنيته مطابقة لمخطط السيرفر، فالاستبدال لاحقًا يكون في مصدر البيانات فقط.
   ============================================================================= */
window.SEED = {
