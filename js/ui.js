...
window.UI = (function () {
  ...
  const icon = {
    ...
    // ترس فعلي. الشكل السابق (دائرة + ٨ أشعّة) هو رسم الشمس حرفيًا، فكان
    // زر «حسابي» يُقرأ كمفتاح إضاءة — انظر `sun` أدناه لترى أنهما كانا نفس
    // الأيقونة تقريبًا.
    settings: (s) => svg('<circle cx="12" cy="12" r="3"/>'
