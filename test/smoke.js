...
// ظاهرًا مباشرة تحت مادته بقائمة «موادّي» (.srow/.steach) بدل شريط منفصل.
...
// سهم بطاقة الأستاذ الزخرفي (.tcard__go) انشال مع الشريط كلّه أعلاه. سهم
// المسار الحالي الوحيد بالرئيسية هو .srow__chev، ووظيفته مختلفة تمامًا
// (فتح/طيّ صفّ الأستاذ لا الانتقال) — مفحوص أعلاه ضمن قسم قائمة «موادّي».
