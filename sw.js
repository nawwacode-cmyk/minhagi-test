...
const VERSION = 'manhaji-shell-v62';

const SHELL = [
  './', './index.html',
  './css/tokens.css', './css/app.css',
  './js/ui.js', './js/data/blobstore.js', './js/data/seed.js', './js/store.js', './js/components.js',
  './js/data/api.js', './js/data/report.js', './js/data/device.js', './js/data/sync.js', './js/data/media.js', './js/data/doc.js',
  './js/screens/onboarding.js', './js/screens/evicted.js', './js/screens/halted.js', './js/screens/progress.js',
  './js/screens/main.js', './js/screens/account.js', './js/screens/course.js', './js/screens/exam.js', './js/screens/plan.js', './js/app.js',
